...
pub extern fn puff(dest: [*c]u8, destlen: [*c]c_ulong, source: [*c]const u8, sourcelen: [*c]c_ulong) c_int;
...
pub const __clang_version__ = "13.0.0 (https://github.com/ziglang/zig-bootstrap.git 4ed79aefb7a58a6d642f47a81e1ef04fd164042b)";
...
pub const __VERSION__ = "Clang 13.0.0 (https://github.com/ziglang/zig-bootstrap.git 4ed79aefb7a58a6d642f47a81e1ef04fd164042b)";
...
pub const NIL = @import("std").zig.c_translation.cast([*c]u8, @as(c_int, 0));
